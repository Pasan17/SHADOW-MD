...
console.log("Connecting SHADOW-MG BOT ⚡...");
...
let up = `SHADOW-MD CONNETED SUCCESSFULLY ✅\n\nPREFIX:BOT CONNECTED SUCCESSFUL ENJOY BOT 😻⚡💗${prefix}`;
...
if(senderNumber.includes("94775049552")){
if(isReact) return
m.react("🤹🏻‍♂️")
}
//=====================✓
...
app.get("/", (req, res) => {
res.send("hey, SHADOW-MD started✅");
});
